...
class SpecificationItemAccessory extends Model
{
    use SoftDeletes;

    protected $table = 'specification_product_accessories';
    ...
    {
        return $this->belongsTo(SpecificationItem::class, 'spec_product_id');
    }
