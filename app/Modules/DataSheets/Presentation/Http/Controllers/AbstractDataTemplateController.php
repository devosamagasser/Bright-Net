...
abstract class AbstractDataTemplateController
{
    ...
    abstract protected function type(): ?DataTemplateType;
    ...
    public function index(Request $request)
    {
        ...
        $paginator = $this->listDataTemplates->handle($perPage, $this->type());
    ...
    public function store(StoreDataTemplateRequest $request)
    {
        ...
        $template = $this->createDataTemplate->handle($input, $this->type());
    ...
    {
        $template = $this->showDataTemplate->handle($dataTemplate, $this->type());
    ...
    {
        $input = DataTemplateInput::fromArray($request->validated());
        $template = $this->updateDataTemplate->handle($dataTemplate, $input, $this->type());
    ...
    {
        $this->deleteDataTemplate->handle($dataTemplate, $this->type());
